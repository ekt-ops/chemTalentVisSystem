...
devtools::install\_github("YOUR\_USERNAME/chemTalentVisSystem")
...
\# run\_app(host = "0.0.0.0", port = 8080)
...
\- \*\*计算引擎\*\*: \[`chemTalentMatchEngine`](https://github.com/YOUR\_USERNAME/chemTalentMatchEngine)（数据清洗与AHP权重计算）
...
│   ├── modules\_radar.R    # 雷达图模块

│   └── utils\_data.R       # 数据处理工具
